...
class Neuron:
    ...
    def gradient_descent(self, X, Y, A, alpha=0.05):
        """does a single pass of gradient descent
        alpha = learning rate = weird looking loop
        J(w,b) = loss function
        new w = w - alpha * (derivative of J(wb) respect w)
        new b = b - alpha * (derivative of J(wb) respect b)
        """
        pass
