...
this file is baased on normal.py from the probability directory
that file does NOT correctly calculate CDF
    CDF method will need to be updated to be used.
"""
e = 2.7182818285
pi = 3.1415926536
